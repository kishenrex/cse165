...
public class AnchorTutorialUIManager : MonoBehaviour
{
    ...
    [SerializeField]
    private GameObject _surfacePlanePrefab;
    ...
    void Update()
    {
        if (OVRInput.GetDown(OVRInput.Button.PrimaryIndexTrigger)) // Create a green capsule
        {
            ...
            var go = Instantiate(_surfacePlanePrefab, _saveableTransform.position, _saveableTransform.rotation); // Anchor A
    ...
    private void OnLocalized(bool success, OVRSpatialAnchor.UnboundAnchor unboundAnchor)
    {
        ...
        var go = Instantiate(_surfacePlanePrefab, pose.position, pose.rotation);
